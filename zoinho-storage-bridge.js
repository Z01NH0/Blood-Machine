(() => {
  ...
  function applySnapshot(payload) {
    ...
    // O Blood Machine carrega o perfil no boot. Recarregar uma vez reconstrói o estado em memória
    // usando o save restaurado sem empilhar patches no código do jogo.
  ...
  function showOriginApproval(origin, approve, deny) {
    ...
    shell.innerHTML = `
      <div class="zoinho-bridge-approval-card">
        ...
        <p>O portal abaixo quer sincronizar o progresso do Blood Machine neste navegador.</p>
        <code></code>
